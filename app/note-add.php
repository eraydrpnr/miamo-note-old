...
<div class="container">
  ...
  <video controls class="video" preload="metadata">
            <source src="./assets/image/tutorial/headings.mp4" type="video/mp4">
...
<div>
  ...
  <div class="content-body">
  <video controls class="video" preload="metadata">
            <source src="./assets/image/tutorial/emphasis.mp4" type="video/mp4">
            Your browser does not support the video tag.
  </video>
  ...
  **_Bold and Italic_** : <strong><em>bold and italic</em></strong>
  ...
  <div class="content-c">
  <div class="content-body">
  <p>You currently cannot upload images to your notes, but you can use external links to insert images.<br>
  Usage:<br>
  ![Miamo Image Description](https://miamonote.com/assets/image/logo.png "Miamo Image Description")<br>
  Make sure to include everything, including the exclamation mark (!).
  
  </p>
  </div></div>
  
  <button type="button" class="collapsible"><h2>Tables</h2></button>
  <div class="content-c">
  <div class="content-body">
  <p>Inserting Tables<br>
  While it's a bit tricky, you can insert tables. Usage:<br>
  |  * | Price   | Quantity  |<br>
  | --|:-------:| -------:| <br>
  | A | $1000   | 1        |<br>
  | B | $100    | 10       |<br>
  ...
  <button type="button" class="collapsible"><h2>Inserting a Line</h2></button>
  <div class="content-c">
  <div class="content-body">
  <p><br>
  To insert a line, move down one line after the previous paragraph and one line below the next paragraph. Usage:<br>
  <span style="background-color: var(--default-grey); color: aliceblue; width: 100%;">
  <br>
  --- <br>
